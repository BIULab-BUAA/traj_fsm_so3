...
LastEditTime: 2024-02-23 01:12:24
...
omega = 2.0
mpitch = 0.6*math.sin(omega*(duration+0.00))
...
start_state = np.array([0,0,2.5])
end_state = np.array([5.1,0,2.0])
# end2_state = np.array([10,0,1.0])

sv_state = np.array([0, 0, 0])

ev_state = np.array([0.2, 0, -0.1])
# ev2_state = np.array([0, 0, 0])

sa_state = [0, 0, 0]
ea_state = [acc_x, acc_y, 0]
# ea2_state = [0, 0, 0]
