...
LastEditTime: 2024-02-13 20:20:32
...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        if(t < 1e-6):
            continue
        # 8 zi
        # traj.position.x =  4 * math.sin(t/2) 
        # traj.velocity.x =  2 * math.cos(t/2)
        # traj.acceleration.x = -1 * math.sin(t/2)

        # traj.position.y =  4 * math.sin(t)
        # traj.velocity.y = 4 * math.cos(t)
        # traj.acceleration.y = -4 * math.sin(t)
        ...
        traj.position.x =  3 * math.sin(t) 
        traj.velocity.x =  3 * math.cos(t)
        traj.acceleration.x = -3 * math.sin(t)

        traj.position.y = 3 * math.cos(t)
        traj.velocity.y = -3 * math.sin(t)
        traj.acceleration.y = -3 * math.cos(t)
